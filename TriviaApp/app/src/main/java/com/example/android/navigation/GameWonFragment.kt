...
class GameWonFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val toastString = "Correct answers: ${args.numCorrects} / num of questions: ${args.numQuestions}"
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        ...
        // Useful for two or more menu items
    ...
    private fun getShareIntent() : Intent {
        ...
        return shareIntent*/
        return ShareCompat.IntentBuilder.from(activity!!).setType("text/plain").setText(getString(R.string.share_success_text, args.numCorrects, args.numQuestions)).intent
        /*return Intent().apply {
